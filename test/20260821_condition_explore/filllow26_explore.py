...
days = sorted(f.stem for f in MERGED.glob('*.parquet') if '20260101' <= f.stem <= '20260817')[::2]
...
pickle.dump(rows, open(OUT / 'filllow26_daily.pkl', 'wb'))
print('FILLLOW26 SCAN DONE', flush=True)
